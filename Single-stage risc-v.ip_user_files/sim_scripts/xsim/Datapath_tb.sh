...
#
# Script generated by Vivado on Mon Jul 20 20:39:27 +0530 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Datapath_tb.sh
...
#
# Usage        : Datapath_tb.sh
#                Datapath_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Datapath_tb.sh [-reset_run]
#                Datapath_tb.sh [-reset_log]
#                Datapath_tb.sh [-help]
#
...
# script info
echo -e "Datapath_tb.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Datapath_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot Datapath_tb xil_defaultlib.Datapath_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Datapath_tb -key {Behavioral:sim_1:Functional:Datapath_tb} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Datapath_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Datapath_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Datapath_tb.sh [-help]\n\
Usage: Datapath_tb.sh [-step]\n\
Usage: Datapath_tb.sh [-lib_map_path]\n\
Usage: Datapath_tb.sh [-reset_run]\n\
Usage: Datapath_tb.sh [-reset_log]\n\
Usage: Datapath_tb.sh [-keep_index]\n\
Usage: Datapath_tb.sh [-noclean_files]\n\n\
